...
internal fun ensureBootstrapJavaBin(
  ...
  install: (String, KoltPaths) -> Result<Unit, ToolchainError> = { v, p ->
    installJdkToolchain(v, p, progressSink = ::eprintln)
  },
    ...
    resolve(paths)
      ?: return Err(
        BootstrapJdkError(
          installDir,
          ToolchainError(
            "java binary not found at ${paths.javaBin(BOOTSTRAP_JDK_VERSION)} after installation"
          ),
        )
      )
  return Ok(javaBin)
