...
class ToolManagerTest {
  ...
  fun toolSpecBuildDownloadUrl() {
    ...
    assertEquals(
      "$MAVEN_CENTRAL_BASE/com/facebook/ktfmt/0.54/ktfmt-0.54-jar-with-dependencies.jar",
      url,
    )
  }
  ...
  fun toolSpecToolPath() {
    ...
    val path = spec.toolPath("/home/user/.kolt/tools")
    assertEquals("/home/user/.kolt/tools/ktfmt-0.54-jar-with-dependencies.jar", path)
  }
