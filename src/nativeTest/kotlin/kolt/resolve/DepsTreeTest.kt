...
class DepsTreeTest {
  ...
  private fun pomInfo(deps: List<PomDependency> = emptyList()) =
    PomInfo(
      parent = null,
      groupId = null,
      artifactId = "",
          ...
          children =
            listOf(
              TreeNode(
                "com.example:lib-b",
                "2.0.0",
                children = listOf(TreeNode("com.example:lib-c", "3.0.0")),
              )
            ),
        ),
  ...
  fun duplicateSubtreeMarkedWithStar() {
    val directDeps = mapOf("com.example:lib-a" to "1.0.0", "com.example:lib-b" to "1.0.0")
    val pomLookup = { ga: String, _: String ->
      when (ga) {
  ...
  fun formatTreeSingleRoot() {
    val tree = listOf(TreeNode("com.example:lib-a", "1.0.0"))
  ...
  fun nativeTreeWalksTransitiveDependencies() {
    ...
    val lookup = { ga: String, _: String ->
      when (ga) {
        "org.jetbrains.kotlinx:kotlinx-serialization-json" ->
          nativeInfo(
            "org.jetbrains.kotlinx:kotlinx-serialization-json-linuxx64",
            "1.7.3",
            deps = listOf("org.jetbrains.kotlinx:kotlinx-serialization-core" to "1.7.3"),
          )
        "org.jetbrains.kotlinx:kotlinx-serialization-core" ->
          nativeInfo("org.jetbrains.kotlinx:kotlinx-serialization-core-linuxx64", "1.7.3")
        else -> null
      }
    }
    ...
    assertEquals(
      "org.jetbrains.kotlinx:kotlinx-serialization-core-linuxx64",
      root.children[0].groupArtifact,
    )
  ...
  fun nativeTreeHandlesCycleViaVisited() {
    ...
    val lookup = { ga: String, _: String ->
      when (ga) {
        "com.example:lib-a" ->
          nativeInfo(
            "com.example:lib-a-linuxx64",
            "1.0",
            deps = listOf("com.example:lib-b" to "1.0"),
          )
        "com.example:lib-b" ->
          nativeInfo(
            "com.example:lib-b-linuxx64",
            "1.0",
